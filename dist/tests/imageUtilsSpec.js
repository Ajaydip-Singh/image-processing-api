...
describe("Test image resizing", function () {
    ...
    var _loop_1 = function (i) {
        ...
        it("should resize the image to width " + widths[i] + " and height " + heights[i], function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                image_utils_1.resizeImage(inputFile, outputFile, widths[i], heights[i]);
                setTimeout(function () { return __awaiter(void 0, void 0, void 0, function () {
                    var imageData;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, image_utils_1.getImageMetadata(outputFile)];
                            case 1:
                                imageData = _a.sent();
        ...
        afterEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, file_utils_1.deleteFile(outputFile)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
